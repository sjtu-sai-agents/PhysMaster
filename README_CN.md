...
<div align="center">
<table><tr>
<td width="50%"><img src="assets/workflow.jpg" alt="PhysMaster 架构"/></td>
<td width="50%"><img src="assets/workflow2.jpg" alt="PhysMaster 流程"/></td>
</tr></table>
</div>
...
**2. 编写问题** &mdash; 创建一个纯文本文件（支持 LaTeX）：
...
`LANDAU/library/` 使 Theoretician 在求解时可以搜索和检索 arXiv 论文，提供超越教材知识库的前沿参考。
...
PhysMaster 可以作为 **skill 插件**安装到 AI agent 平台：
...
之后 `use_skill(name="physmaster", ...)` 调用。
